...
create table "Желчный пузырь" (
   "номер исследования желчного пузыря" bigint               AUTO_INCREMENT               not null,
   форма                text                 null,
...
create table "желчные протоки" (
   "номер исследования желчных протоков" bigint               AUTO_INCREMENT               not null,
...
create table пациент (
   "айди пациента"      bigint               AUTO_INCREMENT               not null,
...
/*==============================================================*/
create table печень (
   "номер исследования печени" bigint               AUTO_INCREMENT               not null,
   доступ               text                 null,
...
create table "поджелудочная железа" (
   "номер исследования поджелудочной железы" bigint               AUTO_INCREMENT               not null,
   головка              int                  null,
   тело                 int                  null,
   хвост                int                  null,
...
create table "узи почек" (
   "айди пациента"      bigint               not null,
   "номер исследования узи почек" bigint               AUTO_INCREMENT               not null,
